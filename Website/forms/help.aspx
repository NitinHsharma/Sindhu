<%@ Page Title="" Language="C#" MasterPageFile="~/forms/Site.Master" AutoEventWireup="true" CodeBehind="help.aspx.cs" Inherits="Website.forms.help" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-3 col-lg-3">
                    <h1 class="h1 text text-white">FAQ</h1>
                </div>
            </div>
        </div>
    </div>
